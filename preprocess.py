...
def get_iemocap():
    ...
    if args.dataset == "iemocap":
        ...
        (
            ...
            open(args.data_root +"./data/meld/MELD_features.pkl", "rb"), encoding="latin1"
        )
...
def main(args):
    if args.dataset == "iemocap":
        ...
        derhgl.utils.save_pkl(data, args.data_root + "/data/iemocap/data_iemocap.pkl")
    if args.dataset == "iemocap_4":
        train, dev, test = get_iemocap()
        data = {"train": train, "dev": dev, "test": test}
        derhgl.utils.save_pkl(data, args.data_root + "/data/iemocap_4/data_iemocap_4.pkl")
    if args.dataset == "meld":
        train, dev, test = get_iemocap()
        data = {"train": train, "dev": dev, "test": test}
        derhgl.utils.save_pkl(data, "data/meld/data_meld.pkl")
